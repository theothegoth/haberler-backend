#!/usr/bin/env python3
"""
Script to update cache invalidation in controllers to use Promise.allSettled
Run on server: python3 fix-cache.py
"""
...
def update_file(filepath, filename):
    """Update cache invalidation patterns in a file"""
    try:
        ...
        # Pattern 1: Three separate cache invalidation calls (most common)
        pattern1 = re.compile(
        ...
        # Pattern 2: Single deleteCache (for updateImageCaption)
        pattern2 = re.compile(
        ...
        # Pattern 3: Four cache invalidation calls (for deleteNews)
        pattern3 = re.compile(
